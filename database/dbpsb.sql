...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2017 at 10:07 PM
...
CREATE TABLE IF NOT EXISTS `cara_daftar` (
  `id_caradft` int(5) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dok_foto` (
  `id_dok_foto` int(5) NOT NULL AUTO_INCREMENT,
  `no_reg` varchar(11) NOT NULL,
  `tgl_up_foto` date NOT NULL,
  `pic_foto` varchar(100) NOT NULL,
  PRIMARY KEY (`id_dok_foto`)
...
CREATE TABLE IF NOT EXISTS `dok_ijazah` (
  `id_dok_ijazah` int(5) NOT NULL AUTO_INCREMENT,
  `no_reg` varchar(11) NOT NULL,
  `tgl_up_ijazah` date NOT NULL,
  `pic_dok_ijazah` varchar(100) NOT NULL,
  PRIMARY KEY (`id_dok_ijazah`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `dok_kk` (
  `id_dok_kk` int(5) NOT NULL AUTO_INCREMENT,
  `no_reg` varchar(11) NOT NULL,
  `tgl_up_kk` date NOT NULL,
  `pic_dok_kk` varchar(100) NOT NULL,
  PRIMARY KEY (`id_dok_kk`)
...
CREATE TABLE IF NOT EXISTS `identitas_web` (
...
CREATE TABLE IF NOT EXISTS `ujian_masuk` (
